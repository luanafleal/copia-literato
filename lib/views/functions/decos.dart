...
//funções
dynamic inputDecoration(String? help, String? erro, String hintText,
    [IconData? icon, IconButton? suffixinIcon]) {
...
dynamic corBorda(bool ehAmarelo) {
  Color cor = ehAmarelo
      ? Color.fromARGB(201, 243, 164, 164)
      : Color.fromARGB(255, 252, 200, 116);
  return cor;
}
...
dynamic boxPontos() {
  return BoxDecoration(
      ...
      borderRadius: BorderRadius.vertical(bottom: Radius.elliptical(150, 30)));
}

dynamic paddingCaixaPontos(bool ehQntd) {
  EdgeInsets padding = ehQntd
      ? EdgeInsets.only(left: 30, top: 13, bottom: 13)
      : EdgeInsets.all(13);
  return padding;
}
